...
import { Map, Navigation, AlertTriangle, Info, User, Plane, PlaneTakeoff } from "lucide-react";
...
const navItems = [
  ...
  { name: "Vols", href: "/flights", icon: PlaneTakeoff },
...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="grid grid-cols-5 px-2" style={{ height: "68px" }}>
          {navItems.map((item) => {
            const Icon = item.icon;
            const isActive = pathname === item.href;
            return (
