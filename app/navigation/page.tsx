...
export default function NavigationPage() {
  ...
  const popularDestinations = [
    { id: "gate-a1", name: "Portes A1-A3", icon: "🛫", type: "Embarquement" },
    { id: "gate-b1", name: "Portes B1-B3", icon: "🛫", type: "Embarquement" },
    { id: "toilet-main", name: "Toilettes", icon: "🚻", type: "Services" },
    { id: "restaurant-maquis", name: "Restaurants", icon: "🍽️", type: "Restauration" },
    { id: "shop-duty-free", name: "Duty Free", icon: "🛍️", type: "Shopping" },
    { id: "lounge-business", name: "Salon Business", icon: "✨", type: "Lounge" },
    { id: "baggage-claim", name: "Retrait bagages", icon: "🧳", type: "Arrivée" },
    { id: "information-main", name: "Information", icon: "ℹ️", type: "Services" },
  ];

  const currentLocations = [
    { id: "entrance-main", name: "Entrée principale", icon: "🚪" },
    { id: "checkin-economy", name: "Enregistrement", icon: "✅" },
    { id: "security-main", name: "Contrôle sécurité", icon: "🔒" },
    { id: "gate-a1", name: "Zone d'embarquement", icon: "🛫" },
  ];
    ...
    >
      ...
      >
        <div className="px-4 py-4">
          ...
          >
            Trouvez votre chemin dans l'aéroport
          </p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-sm opacity-90">
                {routeSteps.length} étapes • Niveau de difficulté: Facile
              </p>
            </div>
            ...
            {currentStep >= routeSteps.length - 1 && (
              ...
              >
                ...
                <h3 className="font-bold text-lg mb-1">Vous êtes arrivé!</h3>
                <p className="text-sm opacity-90">
        ...
        {!startLocation && !endLocation && routeSteps.length === 0 && (
          ...
          >
            ...
            <p className="text-xs" style={{ color: theme.colors.text.secondary }}>
              Sélectionnez votre position actuelle et votre destination pour obtenir des instructions détaillées
            </p>
          </div>
        )}
      </div>
