      ...
      >
        <div className="px-4 py-4">
          ...
          <div className="flex gap-2">
            {[
              { value: 'all' as const, icon: Plane, count: flights.length },
              { value: 'departure' as const, icon: TrendingUp, count: departures.length },
              { value: 'arrival' as const, icon: TrendingDown, count: arrivals.length },
            ].map((tab) => {
        ...
        <div className="px-4 py-8">
          ...
          >
            ...
            <p className="text-xs" style={{ color: theme.colors.text.secondary }}>
              Aucun vol prévu pour le moment
            </p>
          </div>
        </div>
      ) : (
