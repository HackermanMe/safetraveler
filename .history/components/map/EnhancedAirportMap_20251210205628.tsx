...
export default function EnhancedAirportMap({
  ...
  useEffect(() => {
    ...
    floorLocations.forEach((location) => {
      ...
      const isParking = location.type === "parking";
      ...
      if (isParking) {
        // Special style for parking: bullet point with "P" text, similar to current location marker
        el.style.width = isSelected ? "24px" : "20px";
        el.style.height = isSelected ? "24px" : "20px";
        el.style.cursor = "pointer";
        el.style.borderRadius = "50%";
        el.style.backgroundColor = color;
        el.style.border = `2px solid ${isSelected ? "#fff" : "rgba(255,255,255,0.9)"}`;
        ...
        el.style.color = "#fff";
        el.style.fontSize = isSelected ? "12px" : "10px";
        el.style.fontWeight = "bold";
        el.style.fontFamily = "system-ui, -apple-system, sans-serif";
        el.innerHTML = "P";
      } else {
        // Regular bullet point style for other locations
