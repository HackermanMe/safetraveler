...
export default function HeroCarousel() {
  ...
  useEffect(() => {
    const loadMessages = async () => {
      ...
      for (const loc of locales) {
        try {
          const messagesModule = await import(`@/messages/${loc}.json`);
  ...
  const currentMessage = welcomeMessages[currentIndex] || { text: t("home.welcome"), language: localeNames[locale], locale };
