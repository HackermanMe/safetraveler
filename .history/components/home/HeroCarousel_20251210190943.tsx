...
export default function HeroCarousel() {
  ...
  // Get welcome messages for all available locales
  const welcomeMessages: WelcomeMessage[] = [
    { text: t("home.welcome"), language: localeNames.fr, locale: "fr" },
    { text: t("home.welcome"), language: localeNames.en, locale: "en" },
    { text: t("home.welcome"), language: localeNames.ewe, locale: "ewe" },
  ];

  // Set initial index based on current locale
  useEffect(() => {
    const localeIndex = welcomeMessages.findIndex((msg) => msg.locale === locale);
    if (localeIndex !== -1) {
