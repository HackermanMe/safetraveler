...
import { ChevronDown, Loader2, MapPin, Clock, Search, X, Layers, Filter } from "lucide-react";
...
export default function NavigationPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ backgroundColor: theme.colors.background.default }}>
      ...
      {/* Right Panel - Map */}
      <div className="flex-1 relative flex flex-col" style={{ backgroundColor: theme.colors.background.default }}>
        {/* Search Bar */}
        <div
