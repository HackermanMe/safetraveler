...
export default function ReportPage() {
  ...
  const problemTypes = [
    { value: "security", labelKey: "report.categories.security" },
    { value: "cleanliness", labelKey: "report.categories.cleanliness" },
    { value: "maintenance", labelKey: "report.categories.maintenance" },
              ...
              {problemTypes.map((type) => {
                ...
                return (
                  <button
                    ...
                    onMouseEnter={(e) => {
                      if (!isSelected) {
                        e.currentTarget.style.borderColor = theme.colors.border.dark || theme.colors.gray[400];
