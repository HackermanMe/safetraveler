      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 py-4 md:py-8">
          ...
          <>
            ...
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-2xl p-6 md:p-10 mb-8 overflow-hidden">
                ...
                <div className="flex-1 flex items-center justify-center w-full">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-end pointer-events-none">
                      <div className="w-[200px] md:w-[300px] h-[500px] md:h-[600px] border-2 md:border-4 border-gray-700/30 rounded-l-full mr-8 md:mr-16"></div>
                    </div>
                        ...
                        >
                          ...
                          >
                            <div className="p-4 md:p-6 text-white">
                              ...
                              <p className="text-white/80 text-xs md:text-sm line-clamp-2 md:line-clamp-none">
