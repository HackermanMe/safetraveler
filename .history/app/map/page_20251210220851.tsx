...
export default function MapPage() {
  ...
  // Get all available location types from the type definition
  const allLocationTypes: LocationType[] = [
    "gate",
    "checkin",
    "security",
    "customs",
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          borderTop: `6px solid ${locationColors[type] || theme.colors.gray[500]}`,
                        }}
                      />
                    </div>
                  ) : (
                    // Regular bullet point for other types
                    <div
